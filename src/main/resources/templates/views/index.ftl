...
<head>
    ...
    <link rel="stylesheet" href="/assets/iartisan/css/main.css" media="all"/>
</head>
...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" pc>
                    <a href="javascript:;">
                        <img src="/assets/iartisan/images/face.jpg" class="layui-circle" width="35" height="35">
                        <cite>iartisan</cite>
                    </a>
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="page/login/login.html" class="noAddTab"><i
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像"><img src="/assets/iartisan/images/face.jpg"></a>
        </div>
        ...
        <div class="layui-tab marg0" lay-filter="bodyTab" id="top_tabs_box">
            ...
            <div class="layui-tab-content clildFrame">
                <div class="layui-tab-item layui-show">
                    <iframe src="${ctx.contextPath!''}/main"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="layui-footer footer">
        <p>copyright @2017 iartisan　　<a onclick="donation()" class="layui-btn layui-btn-warn l·ayui-btn-small">关注微信</a>
        </p>
    </div>
</div>
...
<script type="text/javascript" src="/assets/iartisan/js/leftNav.js"></script>
